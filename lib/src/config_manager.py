...
class ConfigManager:
    ...
    def __init__(self):
        ...
        self.default_config = {
            ...
            'recording_mode': 'toggle',  # 'toggle' | 'push_to_talk' | 'auto' | 'hot_mic'
            'hot_mic_enabled': False,  # Back-compat alias for hot_mic mode toggle
            'hot_mic_max_seconds': 30,  # Max rolling buffer duration for hot mic mode
